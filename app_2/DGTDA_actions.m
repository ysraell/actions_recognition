...
function [R_DGTDA,MC_DGTDA,num_max] = DGTDA_actions(trajectories,test_samples,training_samples,dist_method_type,dim_opt_proj,Dim,r,zeta)
...
%     disp('Training step')
    ...
    if (dim_opt_proj>0)
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1-mode
        [Ul,num_max(1,:)] = subspace_proj_DGTDA(training_samples,trajectories,N,l,c*p,1,Dim,r,zeta(1));

        if (dim_opt_proj>1)
            
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2-mode
            [Uc,num_max(2,:)] = subspace_proj_DGTDA(training_samples,trajectories,N,c,l*p,2,Dim,r,zeta(2));

            if (dim_opt_proj>2)
                
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 3-mode
                [Up,num_max(3,:)] = subspace_proj_DGTDA(training_samples,trajectories,N,p,l*c,3,Dim,r,zeta(3));
