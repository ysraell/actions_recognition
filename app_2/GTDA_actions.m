...
function [R_DCMDA,MC_DCMDA,num_max,E_DCMDA] = GTDA_actions(trajectories,test_samples,training_samples,dist_method_type,dim_opt_proj,Dim,r,T_max,tolerancia,zeta)
...
%         disp([l c p])
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1-mode
        [aUl,Ll] = subspace_proj_GTDA(training_samples,trajectories_proj,N,l,c*p,1,zeta);


        if (dim_opt_proj>1)
            
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2-mode
            [aUc,Lc] = subspace_proj_GTDA(training_samples,trajectories_proj,N,c,l*p,2,zeta);

            if (dim_opt_proj>2)
                
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 3-mode
                [aUp,Lp] = subspace_proj_GTDA(training_samples,trajectories_proj,N,p,l*c,3,zeta);
