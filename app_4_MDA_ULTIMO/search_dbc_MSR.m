...
%                         end
        ...
        tic
        [A,~,B] = TEST_step(trajectories,test_samples,training_samples,NN,'f');
        time(t,1)  =toc;
        R(t,1) = A/B;
        tic
        [A,~,B] = TEST_step(trajectories,test_samples,training_samples,NN,'o');
        time(t,2)  =toc;
        R(t,2) = A/B;
    ...
    save(['search_dbc_MSR_R_S' num2str(s) '.mat'])
